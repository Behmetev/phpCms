        ...
        <div class="single-main">
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    ...
                    $cats = \phpCms\App::$app->getProperty('cats');
                    ?>
                                ...
                                <div class="col-md-4 product-left p-left">
                                    <div class="product-main simpleCart_shelfItem">
                                        ...
                                        <div class="product-bottom">
                                            ...
                                            <p>Explore Now</p>
                                            <h4>
                                                <a class="item_add add-to-cart-link" data-id="<?= $item['id']; ?>" href="cart/add?id=<?= $item['id']; ?>"><i></i>
                                                </a>
                ...
                <? } ?>
                <?php if ($resentlyViwed) { ?>
                    <div class="latestproducts">
                        <div class="product-one">
                            <h3>Вы смотрели</h3>
                            <?php foreach ($resentlyViwed as $item) { ?>
                                <div class="col-md-4 product-left p-left">
                                    <div class="product-main simpleCart_shelfItem">
                                        <a href="/product/<?= $item['alias']; ?>" class="mask">
                                            <img class="img-responsive zoom-img" src="/images/<?= $item['img']; ?>" alt="" />
